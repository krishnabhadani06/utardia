...
// To parse this JSON data, do
//
//     final todaysProductDealModel = todaysProductDealModelFromJson(jsonString);

import 'dart:convert';

TodaysProductDealModel todaysProductDealModelFromJson(String str) =>
    TodaysProductDealModel.fromJson(json.decode(str));

String todaysProductDealModelToJson(TodaysProductDealModel data) =>
