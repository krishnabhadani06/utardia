...
import 'package:country_pickers/country.dart' as county;
...
class AddressProvider extends ChangeNotifier {
  ...
  void init(
      ...
      Data? data}) {
    if (isAdd == true) {
      currentCountry = CountryPickerUtils.getCountryByName("India");
      ...
      if (data != null) {
        if (data.countryName!.isEmpty) {
          currentCountry = CountryPickerUtils.getCountryByName("India");
        } else {
          currentCountry =
              CountryPickerUtils.getCountryByName(data.countryName.toString());
        }
