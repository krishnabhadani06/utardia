...
class ProductDetailsProvider extends ChangeNotifier {
  ...
  void addToWishList(BuildContext context, String pid) async {
    final provider = Provider.of<SplashProvider>(context, listen: false);
    if (provider.wishListid.contains(pid)) {
      provider.wishListOperation(pid, true);
    } else {
      provider.wishListOperation(
        pid,
      );
    }
  }
